...
(function($) {
    var tagit = {
        ...
        "addTag": function(tag) {
            $(this).trigger("tagit-tag-added", [tag]);
        }, 
        
        removeTag: function(tag) {
            $(this).trigger("tagit-tag-removed", [tag]);
        }
    };
        ...
        tagit: function() {
            ...
            return this.each(function() {
                ...
                if (e.is(".tagit")) {
                    ...
                    var input = $('<input type="text" placeholder="' + placeholder + '" class="no-style" />');
